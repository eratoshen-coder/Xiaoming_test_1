...
# 4. 題目資料
questions = [
    {"p": "校園出口", "i": "image_0.png", "s": "期中考完啦！小明走出校門。", "d": "大腦電力 0%...現在必須吃點重口味的！", "o": [("A. 泰式酸辣粉", "A"), ("B. 苦甜黑巧布朗尼", "B"), ("C. 法式蜂蜜鬆餅", "C"), ("D. 大紅袍麻辣火鍋", "D"), ("E. 札幌濃鹽拉麵", "E")]},
    {"p": "東京巷弄", "i": "image1.png", "s": "夜晚的東京居酒屋街。", "d": "這家店的味道聞起來好專業！點這道？", "o": [("A. 醃漬青梅蘿蔔", "A"), ("B. 炭烤焦香銀杏", "B"), ("C. 日式甜醬油燉肉", "C"), ("D. 四川椒辣串燒", "D"), ("E. 醬油魚卵蓋飯", "E")]},
    {"p": "溫馨老家", "i": "image2.png", "s": "推開家門，飯菜香味撲鼻。", "d": "媽！今天的主菜是我最喜歡的那道嗎？", "o": [("A. 糖醋排骨", "A"), ("B. 苦瓜排骨湯", "B"), ("C. 山藥芋頭甜湯", "C"), ("D. 爆蔥快炒牛肉", "D"), ("E. 東坡肉佐挂包", "E")]},
    {"p": "KTV派對", "i": "image3.png", "s": "霓虹燈閃爍，朋友們都在起鬨。", "d": "口味絕對要挑最令人難忘的那種！", "o": [("A. 法式檸檬塔", "A"), ("B. 咖啡生巧克力奶油蛋糕捲", "B"), ("C. 焦糖布丁", "C"), ("D. 義大利香料蛋糕", "D"), ("E. 紐約起司蛋糕", "E")]},
    {"p": "深夜沙發", "i": "image4.png", "s": "半夜兩點，劇集正播到高潮。", "d": "不來點零食，沒法專心看大結局啊！", "o": [("A. 台南酸甜蜜餞", "A"), ("B. 濃厚抹茶牛奶", "B"), ("C. 焦糖牛奶茶", "C"), ("D. 哇沙米米果", "D"), ("E. 鹹香牛肉乾", "E")]}
]
