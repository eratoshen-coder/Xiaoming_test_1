...
questions = [
    ...
    {"icon": "🏮", "place": "東京巷弄", "img": "image1.png", "story": "夜晚的東京居酒屋街。", "say": "這家店的味道聞起來好專業！點這道？", "opts": [("A. 極致醃漬青梅", "A"), ("B. 炭火焦香銀杏", "B"), ("C. 甜醬嫩燉和牛", "C"), ("D. 哇沙米激辣串燒", "D"), ("E. 醬油醃漬魚卵", "E")]},
    {"icon": "🏠", "place": "溫馨老家", "img": "image2.png", "story": "推開家門，飯菜香味撲鼻。", "say": "媽！今天的主菜是我最喜歡的那道嗎？", "opts": [("A. 秘製糖醋排骨", "A"), ("B. 降火微苦排骨湯", "B"), ("C. 山藥地瓜甜湯", "C"), ("D. 辛香爆蔥快炒肉", "D"), ("E. 紅燒鹹香獅子頭", "E")]},
    {"icon": "🎉", "place": "KTV 派對", "img": "image3.png", "story": "霓虹燈閃爍，朋友們都在起鬨。", "say": "口味絕對要挑最令人難忘的那種！", "opts": [("A. 爆漿檸檬塔", "A"), ("B. 炭焙苦咖啡蛋糕", "B"), ("C. 傳統古法大布丁", "C"), ("D. 肉桂生薑香料糕", "D"), ("E. 海鹽焦糖起司蛋糕", "E")]},
    {"icon": "🎬", "place": "深夜沙發", "img": "image4.png", "story": "半夜兩點，劇集正播到高潮。", "say": "不來點零食，沒法專心看大結局啊！", "opts": [("A. 瞇眼超級酸蜜餞", "A"), ("B. 濃郁厚抹茶苦飲", "B"), ("C. 軟Q牛奶大糖球", "C"), ("D. 嗆鼻哇沙米脆餅", "D"), ("E. 厚切煙燻牛肉乾", "E")]}
]
