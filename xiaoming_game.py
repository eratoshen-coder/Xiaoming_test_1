...
questions = [
    ...
    {"p": "東京巷弄", "i": "image_1.png", "s": "夜晚的東京居酒屋街。", "d": "這家店的味道聞起來好專業！點這道？", "o": [("A. 醃漬青梅", "A"), ("B. 焦香銀杏", "B"), ("C. 甜醬燉肉", "C"), ("D. 激辣串燒", "D"), ("E. 醬油魚卵", "E")]},
    {"p": "溫馨老家", "i": "image_2.png", "s": "推開家門，飯菜香味撲鼻。", "d": "媽！今天的主菜是我最喜歡的那道嗎？", "o": [("A. 糖醋排骨", "A"), ("B. 苦瓜排骨湯", "B"), ("C. 山藥甜湯", "C"), ("D. 爆蔥快炒", "D"), ("E. 紅燒肉", "E")]},
    {"p": "KTV派對", "i": "image_3.png", "s": "霓虹燈閃爍，朋友們都在起鬨。", "d": "口味絕對要挑最令人難忘的那種！", "o": [("A. 檸檬塔", "A"), ("B. 咖啡蛋糕", "B"), ("C. 大布丁", "C"), ("D. 香料蛋糕", "D"), ("E. 起司蛋糕", "E")]},
    {"p": "深夜沙發", "i": "image_4.png", "s": "半夜兩點，劇集正播到高潮。", "d": "不來點零食，沒法專心看大結局啊！", "o": [("A. 酸蜜餞", "A"), ("B. 抹茶飲", "B"), ("C. 牛奶糖", "C"), ("D. 哇沙米", "D"), ("E. 牛肉乾", "E")]}
]
